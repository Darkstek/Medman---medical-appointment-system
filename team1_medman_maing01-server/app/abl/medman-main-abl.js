...
const Errors = require("../api/errors/medman-main-error.js");
...
const logger = LoggerFactory.get("MedmanMainAbl");
...
module.exports = new MedmanMainAbl();
